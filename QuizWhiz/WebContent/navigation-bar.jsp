<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="java.util.*, quizzes.*, users.*, main.*, messages.*, administration.*, quizExtras.*"%>
...
<body>
	...
	<nav class="navbar navbar-default"
		style="background-color: #3ccecc	; background-image: none;">
	<div class="container-fluid"
		style="background-color: #3ccecc; background-image: none; color: #fff">
		...
		<div class="navbar-header" style="background-color: #3ccecc;">
			...
			<a class="navbar-brand" href="index.jsp?" style="color: #fff">Quiz
				Khalifa</a>
		</div>
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav"
				...
				<li><a href="friends.jsp?" style="color: #fff">Friends <%
					if (requests.size() > 0) {
				%><span class="badge"
						style="background-color: #fff; background-image: none; color: #333"><%=requests.size()%></span>
						<%
							}
						%></a></li>
				<li><a href="messages.jsp?" style="color: #fff">Messages <%
					if (unreadMessages.size() > 0) {
				%><span class="badge" style="background-color: #fff; color: #333"><%=unreadMessages.size()%></span>
						<%
							}
						%></a></li>
				<%
				...
				%>
				<li><a href="admin-page.jsp?" style="color: #fff">Admin
						Portal</a></li>
				<%
					}
				%>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					aria-expanded="false"
					style="background-color: #3ccecc; background-image: none; color: #fff">Quizzes
					...
					<ul class="dropdown-menu">
						...
						%>
						<li><a
							href="show-quizzes.jsp?category=<%=FinalConstants.CATEGORIES[i]%>"><%=FinalConstants.CATEGORIES_PLAINTEXT.get(FinalConstants.CATEGORIES[i])%></a></li>
						<%
							}
						%>
			...
			<ul class="nav navbar-nav navbar-right"
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-haspopup="true"
					aria-expanded="false"
					style="background-color: #3ccecc; background-image: none; color: #fff">Settings
						<span class="caret"></span>
				</a>
					<ul class="dropdown-menu">
